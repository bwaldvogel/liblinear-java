    ...
    public void parse_command_line(String argv[]) {
        ...
        for (i = 0; i < argv.length; i++) {
            ...
            switch (argv[i - 1].charAt(1)) {
                case 's':
                    param.solverType = SolverType.getById(Linear.atoi(argv[i]));
                    solver_specified = true;
                    break;
                case 'c':
                    param.setC(Linear.atof(argv[i]));
                    C_specified = true;
                    break;
                case 'p':
                    param.setP(Linear.atof(argv[i]));
                    break;
                case 'e':
                    param.setEps(Linear.atof(argv[i]));
                    break;
                case 'B':
                ...
                case 'C':
                    ...
                    break;
                case 't':
                    param.setThreadCount(Linear.atoi(argv[i]));
                    break;
                default:
